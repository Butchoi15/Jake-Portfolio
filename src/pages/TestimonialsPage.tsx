        ...
        <main className="bg-slate-50 min-h-screen py-24">
            <div className="max-w-7xl mx-auto px-6">
                <div className="max-w-3xl mx-auto text-center mb-20">
                    <div className="inline-flex items-center gap-2 bg-blue-50 text-blue-600 px-4 py-2 rounded-full font-bold text-sm mb-8 uppercase tracking-widest">
                    ...
                    <p className="text-xl text-slate-600 font-medium leading-relaxed">
                        I take pride in delivering high-quality work and building long-term relationships with businesses worldwide. Here is some of the feedback from my past projects.
                    </p>
                </div>
                ...
                <div className="mt-20 text-center">
                    <div className="bg-blue-600 rounded-3xl p-12 text-white max-w-4xl mx-auto shadow-2xl shadow-blue-200">
                        <h2 className="text-3xl md:text-4xl font-black mb-6">Want to be my next success story?</h2>
                        <p className="text-xl font-medium text-blue-100 mb-10">Let's talk about how I can help your business achieve similar results.</p>
                        <a
                            href="/contact"
                            className="bg-white text-blue-600 px-10 py-5 rounded-full text-xl font-bold hover:bg-slate-50 hover:scale-105 transition-all inline-block shadow-lg"
                        >
                            Start Your Project
                        </a>
                    </div>
