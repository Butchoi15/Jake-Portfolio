    ...
    return (
        <main className="bg-white">
            ...
            <section className="relative overflow-hidden bg-black border-b border-slate-800 flex flex-col items-center text-center">
                ...
                <div className="relative z-10 max-w-4xl mx-auto px-6 py-20 md:py-32 space-y-8 flex flex-col items-center">
                    ...
                    <div className="flex flex-wrap gap-4 pt-4 justify-center">
                        <Link
                            to="/contact"
                            className="bg-blue-600 text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-blue-500 transition-transform hover:scale-105 flex items-center gap-2 shadow-lg shadow-blue-500/30"
                        >
                            Let's Work Together <ArrowRight className="w-5 h-5" />
                        </Link>
                    </div>

                    <div className="flex gap-12 pt-12 border-t border-slate-700 justify-center w-full max-w-md">
                        <div>
                            <div className="text-4xl font-black text-white">4+</div>
                            <div className="text-slate-400 font-bold mt-1">Years Experience</div>
                        </div>
                        <div>
                            <div className="text-4xl font-black text-white">100%</div>
                            <div className="text-slate-400 font-bold mt-1">Ready to Help</div>
                        </div>
                    </div>
                </div>
            </section>
